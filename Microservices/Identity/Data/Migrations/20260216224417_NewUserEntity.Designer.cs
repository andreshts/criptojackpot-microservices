...
namespace CryptoJackpot.Identity.Data.Migrations
{
    ...
    [Migration("20260216224417_NewUserEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoJackpot.Identity.Domain.Models.User", b =>
                {
                    ...
                    b.HasIndex("CountryId1")
                        .HasDatabaseName("ix_users_country_id1");
                    ...
                    b.HasIndex("UserGuid")
                        .IsUnique()
                        .HasDatabaseName("ix_users_user_guid");

                    b.ToTable("users", (string)null);
                });

            modelBuilder.Entity("CryptoJackpot.Identity.Domain.Models.UserRecoveryCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CryptoJackpot.Identity.Domain.Models.UserRefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CryptoJackpot.Identity.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("CryptoJackpot.Identity.Domain.Models.Country", null)
                        .WithMany("Users")
                        .HasForeignKey("CountryId1")
                        .HasConstraintName("fk_users_countries_country_id1");
                    ...
                    b.HasOne("CryptoJackpot.Identity.Domain.Models.Role", null)
                        .WithMany("Users")
